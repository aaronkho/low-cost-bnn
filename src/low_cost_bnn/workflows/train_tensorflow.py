...
def parse_inputs():
    ...
    parser.add_argument('--data_file', type=str, required=True, help='Input HDF5 file containing training data set')
    parser.add_argument('--input_vars', type=str, nargs='*', required=True, help='Name(s) of input variables in training data set')
    parser.add_argument('--output_vars', type=str, nargs='*', required=True, help='Name(s) of output variables in training data set')
    parser.add_argument('--validation_fraction', type=float, default=0.1, help='Fraction of data set to reserve as validation set')
    parser.add_argument('--test_fraction', type=float, default=0.1, help='Fraction of data set to reserve as test set')
    parser.add_argument('--shuffle_seed', type=int, default=None, help='Set the random seed to be used for shuffling')
    parser.add_argument('--sample_seed', type=int, default=None, help='Set the random seed to be used for OOD sampling')
    parser.add_argument('--hidden_nodes', type=int, default=20, help='Number of nodes in the common hidden layer')
    parser.add_argument('--specialized_nodes', deafult=None, help='Number of nodes in the specialized hidden layer')
    ...
    parser.add_argument('--metrics_file', type=str, required=True, help='Path and name of HDF5 file to store training metrics')
    parser.add_argument('--network_file', type=str, required=True, help='Path and name of HDF5 file to store training metrics')
