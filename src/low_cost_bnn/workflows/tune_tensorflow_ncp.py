...
import optuna
from .train_tensorflow_ncp import (
    launch_tensorflow_pipeline_ncp
)
...
logger = logging.getLogger("tune_tensorflow")


class HyperparameterTunerTensorflowNCP():
...
def tune_tensorflow_ncp_trial(
    ...
    objective = HyperparameterTunerTensorflowNCP(
        data_path,
        input_vars,
        output_vars,
        settings,
...
def main():
    ...
    if variable_path.is_file():
        trial_data = tune_tensorflow_ncp_trial(
            data_path,
