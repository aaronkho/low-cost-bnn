...
def parse_inputs():
    ...
    parser.add_argument('--minimum_scale', metavar='val', type=float, default=1.0e-3, help='Set minimum value of predicted standard deviations to prevent zero posteriors')
